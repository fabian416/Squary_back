...
__decorate([
    (0, typeorm_1.Column)({ name: 'groupid' }) // Se añade el mapeo al nombre correcto de la columna
    ,
    __metadata("design:type", Number)
], Debt.prototype, "groupId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => group_model_1.Group, group => group.debts),
    (0, typeorm_1.JoinColumn)({ name: 'groupid' }) // Corresponde a la columna groupid en la tabla debts
    ,
...
__decorate([
    ...
    (0, typeorm_1.JoinColumn)({ name: 'transactionid' }) // Corresponde a la columna transactionid en la tabla debts
    ,

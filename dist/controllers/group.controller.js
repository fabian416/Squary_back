...
exports.getGroupMembers =
  ...
  exports.updateGnosisSafeAddress =
  exports.createGroup =
  exports.setIo =
    void 0;
...
const createGroup = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const allUsers = yield database_1.AppDataSource.manager.find(
      user_model_1.User,
      {
        where: {
          walletAddress: (0, typeorm_1.In)([owner, ...walletAddresses]),
        },
      }
    );
    ...
    const savedGroup = yield database_1.AppDataSource.manager.save(
      group_model_1.Group,
      group
    );
    for (const invitee of invitees) {
      if (usersByWallet[invitee.walletAddress]) {
        ...
        yield database_1.AppDataSource.manager.save(
...
const updateGnosisSafeAddress = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { groupId, gnosissafeaddress } = req.body;
    try {
      const group = yield database_1.AppDataSource.manager.findOne(
        group_model_1.Group,
        { where: { id: groupId } }
      );
      if (!group) {

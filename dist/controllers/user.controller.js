...
exports.getWalletAddressesByAliases =
  exports.register =
...
const authenticate = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const user = yield database_1.AppDataSource.manager.findOne(
        user_model_1.User,
...
const register = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      let user = yield database_1.AppDataSource.manager.findOne(
        user_model_1.User,
        { where: { walletAddress: walletAddress } }
      );
      if (!user) {
...
const getWalletAddressesByAliases = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const users = yield user_model_1.User.find({
        where: { alias: (0, typeorm_1.In)(aliases) },
      });
      const result = {};

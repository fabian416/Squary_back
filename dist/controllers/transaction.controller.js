...
exports.getAllTransactions =
  ...
  exports.getTransactionsByGroup =
...
const createTransaction = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (type === 'EXPENSE') {
        yield DebtService.createDebtsFromTransaction(
          newTransaction,
          sharedWith,
          proposedBy
        );
...
const getTransactionsByGroup = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const transactions = yield transaction_model_1.Transaction.find({
        where: { togroupid: Number(groupId) },
      });
      // Obtener todas las direcciones únicas de las transacciones
      const uniqueAddresses = [
        ...new Set(transactions.flatMap((t) => t.sharedWith)),
      ];
      ...
      const transformedTransactions = transactions.map((transaction) =>
        Object.assign(Object.assign({}, transaction), {
          sharedWith: transaction.sharedWith.map(
            (address) => addressToAliasMap[address] || address
          ),
        })
      );
